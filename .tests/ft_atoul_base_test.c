...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_atoul_base_test.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: joesanto <joesanto@student.42porto.com>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/28 19:25:36 by joesanto          #+#    #+#             */
/*   Updated: 2025/10/11 10:09:45 by joesanto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_libc(t_input_libc tab[], size_t size)
{
	...
	while (size--)
	{
		expected = strtoul(tab[size].str, &expected_end, ft_strlen(tab[size].base));
		output = ft_atoul_base(tab[size].str, &output_end, tab[size].base);
...
void	test_myown(t_input_myown tab[], size_t size)
{
	...
	while (size--)
	{
		...
		output = ft_atoul_base(tab[size].str, 0, tab[size].base);
