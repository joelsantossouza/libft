...
ATF_TC_BODY(test02, tc)
{
	t_input	tab[] = {
		{ "漢字😀🚀🔥", 48291, "🌍✨💧🌈😃😄😁", 92734 },
		{ "abcXYZçЖщЮ", 123, "テストデータ📊📈", 99999 },
		{ "😀😃😄😁꧁༺✿༻꧂", 90812, "🎵🎶🎼🥁🎹", 271 },
		{ "ЖщЮяЁЇҐѪ", 56789, "LoremIpsumΔεδομένα", 31415 },
		{ "🐉🐲🦄👾🤖", 777, "こんにちは世界🌌🌠", 888 },
		{ "↔↕↖↗↘↙↩↪", 45001, "©®™✓✔✖漢字", 67890 },
		{ "テスト漢字カタカナ", 91324, "🌌🌠🌟💫🔥💧", 1000 },
		{ "Ω≈ç√∫˜µ≤≥÷", 22222, "꧁༺Unicode༻꧂", 54321 },
		{ "🚀✨🌍🎶🔥💧", 99999, "🐍🐢🦎🦂", 11111 },
		{ "꧁༺✿⚡✿༻꧂", 13579, "🦄👾🤖👽💀☠️", 24680 },
		{ "😀漢字テスト", 20001, "🎭🎨🎬🎤", 30002 },
		{ "🎼🎵🎶", 30003, "∑∆∏∫√", 40004 },
		{ "☀☁❄☂☃", 50007, "qwerty漢字жшюя😀", 60008 },
		{ "テストデータ測定123", 70011, "🎹🥁🎸", 80012 },
		{ "ΔοκιμήUnicode漢字", 90015, "Data測試Тестاختبار", 100016 },
		{ "©®™✓✔✖漢字", 12114, "δθλμνξ", 13115 },
		{ "😆😅😂🤣漢字", 15120, "テスト12345", 16121 },
		{ "こんにちは", 17124, "🐉🐲🦄👾🤖👽", 18125 },
		{ "ЖщЮяЁЇҐѪ", 19128, "LoremIpsum😀", 20129 },
		{ "🌍🚀✨🔥💧", 21132, "ΔεδομέναΣυμβολοσειρά", 22133 },
		{ "طَبْشُورَة", 23136, "नमस्तेभारत漢字", 24137 },
		{ "꧁༺✿⚡✿༻꧂", 25140, "ABCDEFGHIJKLMNOPQRSTUVWXYZ", 26141 },
		{ "©®™✓✔✖😃", 27144, "🦄👾🤖👽💀☠️", 28145 },
		{ "↔↕↖↗↘↙↩↪漢字", 29148, "テストデータPrueba", 30149 },
		{ "🎵🎶🎼漢字かな", 31152, "文字列の長さはテストです", 32153 },
		{ "👑💎⚔️🛡️🏹🎯", 33156, "Ω≈ç√∫˜µ≤≥÷漢字", 34157 },
		{ "Data測試", 35160, "🀄🎴🃏漢字", 36161 },
		{ "abcdefg1234567", 37164, "🎧🎼🎹", 38165 },
		{ "πρστυφ漢字ψω", 39168, "🚀✨🌍🎶🔥💧", 40169 },
		{ "テスト漢字カタカナ123", 41172, "🐍🐢🦎🦂漢字", 42173 },
		{ "Δεδομένα漢字😀🚀", 43176, "🐉🐲🦄👾🤖", 44177 },
		{ "꧁༺Unicode༻꧂", 45178, "Lorem Ipsum 🎶🎼", 46179 },
		{ "🔥💧🌈✨", 47180, "テストデータ🚀🌍", 48181 },
		{ "🌌🌠🌟💫", 49182, "Ω≈ç√∫˜µ≤≥÷", 50183 },
		{ "🎭🎨🎬🎤", 51184, "🐍🐢🦎🦂漢字😀", 52185 },
		{ "🚀✨🌍🎶🔥", 53186, "©®™✓✔✖", 54187 },
		{ "abcdefghi漢字", 55188, "🎹🥁🎸テスト", 56189 },
		{ "नमस्तेभारत", 57190, "꧁༺✿༻꧂", 58191 },
		{ "♠♥♦♣♪♫♬⚡", 59192, "🦄👾🤖👽", 60193 },
		{ "🎧🎼🎹🥁", 61194, "ΔεδομέναΣυμβ", 62195 },
		{ "πρστυφχψω", 63196, "Data測試Тест", 64197 },
		{ "テストデータ測定", 65198, "🌍🚀✨🔥💧", 66199 },
		{ "Ω≈ç√∫˜µ≤≥÷漢字", 67200, "🎵🎶🎼", 68201 },
		{ "©®™✓✔✖", 69202, "꧁༺Unicode༻꧂", 70203 },
		{ "🐍🐢🦎🦂", 71204, "🚀✨🌍🎶", 72205 },
		{ "テキストデータ12345", 73206, "Lorem Ipsum漢字", 74207 },
		{ "😆😅😂🤣", 75208, "🐉🐲🦄👾🤖", 76209 },
		{ "🎭🎨🎬", 77210, "🌌🌠🌟💫", 78211 },
		{ "abcXYZ123ç", 79212, "ΔοκιμήUnicode漢字", 80213 },
		{ "꧁༺✿✿༻꧂", 81214, "🎧🎼🎹🥁", 82215 },
		{ "🚀✨🌍🎶🔥💧", 83216, "Ω≈ç√∫˜µ≤≥÷", 84217 },
		{ "Δεδομένα漢字😀", 85218, "🐍🐢🦎🦂漢字", 86219 },
		{ "テスト漢字カタカナ", 87220, "Lorem Ipsum 🎼", 88221 },
		{ "©®™✓✔✖", 89222, "🎹🥁🎸", 90223 },
		{ "漢字カタカナ123", 91224, "꧁༺✿⚡✿༻꧂", 92225 },
		{ "🎵🎶🎼", 93226, "🌍🚀✨🔥💧", 94227 },
		{ "🐉🐲🦄👾🤖", 95228, "Ω≈ç√∫˜µ≤≥÷漢字", 96229 },
		{ "🌌🌠🌟💫", 97230, "🦄👾🤖👽", 98231 },
		{ "ΔοκιμήUnicode", 99232, "テストデータ", 100233 },
		{ "🎭🎨🎬🎤", 101234, "©®™✓✔✖", 102235 },
		{ "Lorem Ipsum漢字", 103236, "🚀✨🌍🎶🔥", 104237 },
		{ "꧁༺Unicode༻꧂", 105238, "🎧🎼🎹", 106239 },
		{ "🐍🐢🦎🦂", 107240, "ΔεδομέναΣυμβ", 108241 },
		{ "🔥💧🌈✨", 109242, "Ω≈ç√∫˜µ≤≥÷漢字", 110243 },
		{ "テキストデータ123", 111244, "🌌🌠🌟💫", 112245 },
		{ "🎹🥁🎸", 113246, "🐉🐲🦄👾🤖", 114247 },
		{ "abcXYZ123çЖщ", 115248, "Lorem Ipsum 😀", 116249 },
		{ "🐉🐲🦄", 117250, "🚀✨🌍🎶", 118251 },
		{ "Ω≈ç√∫˜µ", 119252, "꧁༺✿⚡✿༻꧂", 120253 },
		{ "テスト漢字カタカナ123", 121254, "🎭🎨🎬", 122255 },
		{ "©®™✓✔✖漢字", 123256, "🐍🐢🦎🦂漢字😀", 124257 },
		{ "🎧🎼🎹🥁", 125258, "🌍🚀✨🔥💧", 126259 },
		{ "Δεδομένα漢字", 127260, "🎵🎶🎼漢字", 128261 },
		{ "꧁༺✿༻꧂", 129262, "Lorem Ipsum 🎶", 130263 },
		{ "πρστυφχψω", 131264, "🎹🥁🎸テスト", 132265 },
		{ "🐉🐲🦄👾🤖", 133266, "Ω≈ç√∫˜µ≤≥÷", 134267 },
		{ "🔥💧🌈", 135268, "🐍🐢🦎🦂", 136269 },
		{ "テスト12345", 137270, "꧁༺Unicode༻꧂", 138271 },
		{ "🌌🌠🌟💫", 139272, "🚀✨🌍🎶🔥", 140273 },
		{ "©®™✓✔✖😃", 141274, "🐉🐲🦄👾🤖", 142275 },
		{ "漢字かなカタカナ", 143276, "🎧🎼🎹", 144277 },
		{ "🎭🎨🎬🎤", 145278, "ΔεδομέναΣυμβ", 146279 },
		{ "Ω≈ç√∫˜µ≤≥÷漢字", 147280, "🌍🚀✨🔥💧", 148281 },
		{ "꧁༺✿⚡✿༻꧂", 149282, "🎵🎶🎼", 150283 },
		{ "テストデータ", 151284, "🐍🐢🦎🦂漢字", 152285 },
		{ "🎹🥁🎸", 153286, "Lorem Ipsum 😀", 154287 },
		{ "🚀✨🌍🎶🔥💧", 155288, "Ω≈ç√∫˜µ≤≥÷", 156289 },
		{ "🐉🐲🦄👾🤖", 157290, "©®™✓✔✖", 158291 },
		{ "Δεδομένα漢字😀", 159292, "🎧🎼🎹", 160293 },
		{ "テスト漢字カタカナ", 161294, "🌌🌠🌟💫", 162295 },
		{ "🔥💧🌈✨", 163296, "🐉🐲🦄👾🤖", 164297 },
		{ "Ω≈ç√∫˜µ≤≥÷", 165298, "Lorem Ipsum 🎶", 166299 },
		{ "꧁༺Unicode༻꧂", 167300, "🚀✨🌍🎶", 168301 },
		{ "🎭🎨🎬🎤", 169302, "🐍🐢🦎🦂漢字😀", 170303 },
		{ "🐉🐲🦄", 171304, "🌍🚀✨🔥💧", 172305 },
		{ "テストデータ測定", 173306, "🎵🎶🎼漢字", 174307 },
		{ "🎧🎼🎹🥁", 175308, "Ω≈ç√∫˜µ≤≥÷", 176309 },
		{ "©®™✓✔✖", 177310, "꧁༺✿⚡✿༻꧂", 178311 },
		{ "🌌🌠🌟💫", 179312, "🚀✨🌍🎶🔥", 180313 }
	};
