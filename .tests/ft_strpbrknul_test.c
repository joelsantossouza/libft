...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_strpbrknul_test.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: joesanto <joesanto@student.42porto.com>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/28 10:31:08 by joesanto          #+#    #+#             */
/*   Updated: 2025/10/02 11:18:41 by joesanto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test(t_input tab[], size_t size)
{
	...
	while (size--)
	{
		expected = strpbrk(tab[size].big, tab[size].little);
		if (!expected)
			expected = (char *) tab[size].big + ft_strlen(tab[size].big);
		output = ft_strpbrknul(tab[size].big, tab[size].little);
