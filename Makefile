...
#    Updated: 2026/01/28 21:46:05 by joesanto         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_atoi.c ft_atoh.c ft_strstr.c ft_strstr_diff.c ft_strstrnul.c ft_strstrnul_diff.c ft_strnstr.c ft_strpbrk.c \
...
ft_max.c ft_static_ltoa_base.c ft_static_ultoa_base.c ft_realloc.c ft_getline.c ft_getfile.c ft_swap.c \
ft_nbrcmp.c ft_buffer_ultoa.c
