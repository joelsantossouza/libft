...
#    Updated: 2025/09/30 20:43:47 by joesanto         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strdup.c ft_strndup.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_striteri.c \
ft_strmapi.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_freearray.c ft_words_count.c ft_split.c
